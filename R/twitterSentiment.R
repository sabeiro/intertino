...
r_stats <- NULL
r_stats <- rbind(r_stats,searchTwitter("@GrandeFratello", n=1500,since = starDate))
r_stats <- rbind(r_stats,searchTwitter("#gf", n=1500,since = startDate))

r_stats <- NULL
r_stats <- rbind(r_stats,searchTwitter("@uominiedonne", n=3000,since = startDate))
r_stats <- rbind(r_stats,searchTwitter("@UominieDonneili", n=3000,since = startDate))
r_stats <- rbind(r_stats,searchTwitter("#uominiedonne", n=3000,since = startDate))
